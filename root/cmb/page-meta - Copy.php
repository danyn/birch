...
function birch_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'classes_cb' => 'birch_add_some_classes', // Add classes through a callback.
	) );
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'birch_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'birch_display_text_small_column', // Output the display of the column values through a callback.
	) );
	$cmb_demo->add_field( array(
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'birch_render_row_cb',
	) );
	$cmb_demo->add_field( array(
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'birch_before_row_if_2', // callback
